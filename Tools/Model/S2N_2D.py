...
class Model(nn.Module):
    def __init__(self, num_classes=10, in_channels=2, enhance_iter=4, nIter=3, enhance=False, **kwargs):
        super(Model, self).__init__()

        self.nsn = NSN.Model(scale_factor=1, in_channels=in_channels, enhance_iter=enhance_iter) if enhance else None
